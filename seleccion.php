...
<body class="flex items-center justify-center">
    <div class="bg-slate-900/90 p-10 rounded-2xl border border-slate-700 shadow-2xl text-center max-w-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="login.php?rol=trabajador" class="group p-6 bg-slate-800 rounded-xl border border-slate-600 hover:border-cyan-400 transition-all">
            ...
            <a href="login.php?rol=cliente" class="group p-6 bg-slate-800 rounded-xl border border-slate-600 hover:border-green-400 transition-all">
                <div class="text-4xl mb-3">📖</div>
